const graph = {
  nodes: [
    { id: "Boss???", color: "#FF5555" },
    { id: "Wen-Mom", color: "#8888FF" },
    { id: "Perry", color: "#A0D1D1" },
    { id: "Mar Sr.", color: "#B399FF"},
    { id: "Mira", color: "#FFAA55"},
    { id: "Sorrel", color: "#888888" },
    { id: "Leslie", color: "#AA99FF"},
    { id: "Unnamed", color: "#88CC55" },
    { id: "Sue", color: "#66AAFF" },
    { id: "Arce", color: "#FF5555" },
    { id: "Wendy", color: "#55AADD" },
    { id: "Hoshi", color: "#88BB66" },
    { id: "Rhys", color: "#FF88CC" },
    { id: "Sybil", color: "#FFFF88"},
    { id: "Melissa", color: "#8888FF" },
    { id: "Lucille", color: "#B399FF" },
    { id: "Mar", color: "#583da8" },
  ],
  links: [
